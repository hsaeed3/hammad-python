...
def get_typeddict_field_names(t: typing.Any) -> typing.List[str]:
    """Returns a list of field names within a TypedDict."""
    if not is_typeddict(t):
        raise TypeError("Provided object is not a TypedDict.")
    return list(t.__annotations__.keys())