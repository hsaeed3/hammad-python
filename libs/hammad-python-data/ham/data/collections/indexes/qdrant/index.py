...
if TYPE_CHECKING:
    try:
        from ham.genai.models.embeddings.types import EmbeddingModelName
    except ImportError:
        from .....genai.models.embeddings.types import EmbeddingModelName  # type: ignore
...
class QdrantCollectionIndex:
    ...
    def _get_embedding_function(self) -> Optional[Callable[[Any], List[float]]]:
        ...
        if self._embedding_function is None and self.embedding_model:
            try:
                from ham.genai.models.embeddings.model import EmbeddingModel
            except ImportError:
                from .....genai.models.embeddings.model import EmbeddingModel  # type: ignore
    ...
    def _rerank_results(
        ...
        try:
            try:
                ...
                from .....genai.models.reranking import run_reranking_model  # type: ignore
