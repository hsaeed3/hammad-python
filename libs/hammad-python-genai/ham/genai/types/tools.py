...
try:
    from ham.core.conversion import convert_to_json_schema
    from ham.core.conversion.pydantic.converters import (
        get_pydantic_fields_from_function,
        convert_to_pydantic_model,
    )
except ImportError:
    from ...conversion import convert_to_json_schema  # type: ignore
    from ...data.models.extensions.pydantic.converters import (  # type: ignore
        get_pydantic_fields_from_function,
        convert_to_pydantic_model,
    )
