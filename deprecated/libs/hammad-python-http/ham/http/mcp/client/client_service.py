"""ham.http.mcp.client.client_service
...
class MCPClientService(abc.ABC):
    ...
    @abc.abstractmethod
    async def list_tools(self) -> list[MCPTool]:  # type: ignore
...
class _MCPClientServiceWithClientSession(MCPClientService, abc.ABC):
    ...
    def __init__(
        ...
        self.server_initialize_result: InitializeResult | None = None  # type: ignore
