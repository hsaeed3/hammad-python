...
if TYPE_CHECKING:
    from .clients.http_client import HttpResponse
...
def run_web_request(
    ...
    async def _run_web_request_async():
        if type == "http":
            ...
            from .clients.http_client import HttpClient as HttpToolkit
            ...
            from .clients.openapi_client import OpenAPIClient as OpenApiToolkit
