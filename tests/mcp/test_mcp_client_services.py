...
from hammad.ai.mcp.client.client_service import (
    MCPClientServiceStdio,
    MCPClientServiceSse,
    MCPClientServiceStreamableHttp,
    UserError,
)
from hammad.ai.mcp.client.settings import (
...
class TestMCPClientServiceWithClientSession:
    ...
    async def test_connect_success(self, mock_client_service):
        ...
        with patch.object(mock_client_service, 'create_streams') as mock_create_streams:
            ...
            with patch('hammad.ai.mcp.client.client_service.ClientSession') as mock_client_session_class:
    ...
    async def test_call_tool_success(self, mock_client_service):
        ...
        mock_client_service.session.call_tool.assert_called_once_with("test_tool", {"arg": "value"})
