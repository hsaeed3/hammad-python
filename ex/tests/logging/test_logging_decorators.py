...
class TestTraceHttp:
    ...
    def test_trace_http_decorator_preserves_metadata(self):
        ...
        assert documented_http_function.__doc__ == "Makes an HTTP request and returns response."
    ...
    def test_trace_http_direct_result_call(self):
        ...
        result = decorators.trace_http(mock_result, show_request=False, show_response=True)
    ...
    def test_trace_http_wrapped_function_call(self):
        ...
        # Wrap the function
        traced_api = decorators.trace_http(api_function, show_request=True, show_response=True)
    ...
    def test_trace_http_llm_response_format(self):
        ...
        assert result.choices[0].message.content == "This is a test response from an LLM"
...
class TestInstallTraceHttp:
    ...
    def test_install_trace_http_no_modules(self):
        ...
        modules_to_remove = [
            "requests", "httpx", "aiohttp", "litellm", "openai", "anthropic"
        ]
