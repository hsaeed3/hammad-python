...
class BaseGenAIModelEvent(BaseModel, Generic[T]):
    ...
    def to_message(self) -> "ChatCompletionMessageParam":
        ...
        raise NotImplementedError(f"to_message() is not implemented for {self.__class__.__name__}")
    ...
    def to_content_part(self) -> "ChatCompletionContentPartParam":
        ...
        raise NotImplementedError(f"to_content_part() is not implemented for {self.__class__.__name__}")
...
class BaseGenAIModelStream(BaseGenAIModelEvent[T]):
    ...
    def __iter__(self) -> Iterator[T]:
        raise NotImplementedError(f"__iter__() is not implemented for {self.__class__.__name__}")
    
    def __aiter__(self) -> AsyncIterator[T]:
        raise NotImplementedError(f"__aiter__() is not implemented for {self.__class__.__name__}")
