...
class HookManager:
    ...
    def register_hook(self, event_type: str, callback: Callable, specific_name: Optional[str] = None):
    ...
    def trigger_hooks(self, event_type: str, data: Any, specific_name: Optional[str] = None) -> Any:
    ...
    def trigger_event(self, event: AgentEvent, specific_name: Optional[str] = None) -> Any:
    ...
    def clear_hooks(self, event_type: Optional[str] = None, specific_name: Optional[str] = None):
...
class HookDecorator:
    ...
    def __getattr__(self, name: str):
        ...
        class DynamicEventType:
            def __init__(self, event_data: Any = None, metadata: Optional[Dict[str, Any]] = None):
