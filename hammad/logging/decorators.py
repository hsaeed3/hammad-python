        ...
        def wrapper(*args: _P.args, **kwargs: _P.kwargs) -> _R:
            ...
            try:
                ...
                if rich and bg:
                    ...
                    exit_msg = f"← Exiting {module_name}.{func_name}() (took {exec_time:.3f}s)"
    ...
    *,
    ...
    def decorator(target_cls: Type[Any]) -> Type[Any]:
        ...
        def traced_init(self, *args, **kwargs):
            ...
            if rich:
                create_msg = f"[{style}]🏗  Creating instance of {target_cls.__name__}[/{style}]"
            else:
        ...
        if attributes:
            original_setattr = target_cls.__setattr__ if hasattr(target_cls, '__setattr__') else object.__setattr__
...
def trace(
    ...
    *,
    ...
    bg: Union[CLIStyleBackgroundType, str] = None,
) -> Union[Callable[_P, _R], Type[Any], Callable[[Union[Callable[_P, _R], Type[Any]]], Union[Callable[_P, _R], Type[Any]]]]:
    """
    ...
    """
    def decorator(target: Union[Callable[_P, _R], Type[Any]]) -> Union[Callable[_P, _R], Type[Any]]:
