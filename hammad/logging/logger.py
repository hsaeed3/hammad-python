...
LoggingLevelName: TypeAlias = Literal["debug", "info", "warning", "error", "critical"]
...
class LoggerLevelSettings(TypedDict, total=False):
    ...
    background: StyleColorName | StyleBackgroundSettings
...
class Logger:
    ...
    def __init__(
        ...
        level: Optional[LoggingLevelName | str] = None,
        rich: bool = True,
...
def get_logger(
    ...
    rich: bool = True,
    display_all: bool = False,
    levels: Optional[Dict[LoggingLevelName, LoggerLevelSettings]] = None,
) -> Logger:
    """
